...
class Pac {
	...
	public static inline var IMPORTANCE_SUPERFOOD = 90;
	...
	public function navigate() {
		...
		// abilityCooldown
		// speed
		// if( id == 0 ) CodinGame.printErr( '$id hunt $huntDistance danger $dangerDistance cooldown $abilityCooldown speed $speed' );
