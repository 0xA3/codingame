...
class PathNode {
	...
	public static final NO_NODE = new PathNode( Pos.NO_POS, [], Pos.NO_POS, null, 0, 0 );

	public var posIn:Pos;
	public var posOut:Pos;
	public var previous:PathNode;
	public var depth:Int;
	public var bodyPositions:Array<Pos>;
	public var outsideCount:Int;
	
	public function new( posIn:Pos, bodyPositions:Array<Pos>, posOut:Pos, previous:PathNode, depth:Int, outsideCount = 0 ) {
		this.posIn = posIn;
