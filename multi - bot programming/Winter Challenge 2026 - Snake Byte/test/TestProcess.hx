...
class TestProcess extends buddy.BuddySuite {
	...
	static function parseInputparseBoardInput input:String ) {
		initReadline( input );
	...
	final test1 = parseInputparseBoardInput
		"6 550 700 200"
	);
	...
	final test2 = parseInputparseBoardInput
		"12 800 600 900"
	);
	...
	final test3 = parseInputparseBoardInput
		"12 800 500 500"
	);
	...
	final test4 = parseInputparseBoardInput
		"12 800 600 600"
	);
	...
	final test5 = parseInputparseBoardInput
		"8 600 600 600"
	);
